# 🧪 Self-Test: Cloud Computing (Topic 1)

## 🔹 Level 1: Quick Recall (No thinking, direct answers)
...
6. Agar ek startup hai jiska traffic kabhi low kabhi high hota hai, wo cloud kyu use karega? - **Traffic low hai to Resouce Kam jayda, Agar high use to resource automatically badh jata hai**
...
## 🔹 Level 3: Real Thinking (Interview Level 🔥)
...
12. Cloud use karne ka ek disadvantage batao : **Dependency on the internet to access, Security concern hota hai or less control bhi**
...
14. Local server kab better ho sakta hai cloud se? - **No Internet dependency, full control, privacy**
